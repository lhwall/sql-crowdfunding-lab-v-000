...
"SELECT projects.category, sum(pledges.amount) FROM projects WHERE projects.category IS \'music\' JOIN pledges ON projects.id=pledges.project_id GROUP BY pledges.project_id"
end
