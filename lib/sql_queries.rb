...
"SELECT projects.category, sum(pledges.amount) WHERE projects.category = \'music\' FROM projects JOIN pledges ON projects.id=pledges.project_id GROUP BY pledges.project_id"
end
