...
"WHERE projects.category='music' SELECT projects.category, sum(pledges.amount) FROM projects JOIN pledges ON projects.id=pledges.project_id GROUP BY pledges.project_id"
end
